...
export function createContainerCreateTool(
  ...
  return {
    ...
    description:
      ...
      "and maintains its filesystem state. You can optionally clone a git repository " +
      "into /workspace. Container egress is routed through Clawflare's security layer.",
    ...
    parameters: Type.Object({
      ...
      cloneUrl: Type.Optional(Type.String({
        description: "Optional git URL to clone into /workspace upon creation",
      })),
    }) as TSchema,
    execute: async (
      _toolCallId: string,
