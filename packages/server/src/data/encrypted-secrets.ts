...
import type { EncryptedSecretEnvelope } from "../modules/secrets/secrets.crypto.js";
 ...
 */
export class EncryptedSecretRepository implements EncryptedSecretStore {
 ...
 */
export function getEncryptedSecretRepository(db: D1Database): EncryptedSecretStore {
  return new EncryptedSecretRepository(db);
}
