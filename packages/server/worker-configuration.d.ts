/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 633483a0a783c9a46ff2ae35cf5882a8)
// Runtime types generated with workerd@1.20260526.1 2025-01-01 enable_ctx_exports,nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	LOADER: WorkerLoader;
	AI_PROVIDER: "amazon-bedrock";
	AI_MODEL: "minimax.minimax-m2.5";
	WEBSOCKET_SESSION: DurableObjectNamespace<import("./src/index").ClawflareWebSocketSession>;
	CODING_CONTAINER: DurableObjectNamespace<import("./src/index").CodingContainer>;
	HTTP_GATEWAY: Service<typeof import("./src/index").HttpGateway>;
	AGENT_WORKFLOW: Workflow<Parameters<import("./src/index").PersistentSessionWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ClawflareWebSocketSession" | "CodingContainer";
	}
